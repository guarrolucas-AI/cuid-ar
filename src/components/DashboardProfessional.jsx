...
// Banner que muestra el estado de verificación de identidad al profesional.
// Solo visible cuando el status NO es 'clear'. Permite re-subir el PDF.
function IdentityBanner({ notify }) {
